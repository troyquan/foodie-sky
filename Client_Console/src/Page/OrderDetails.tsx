...
const OrderDetails = () => {
    ...
    return (
        <div>
            ...
            {!isLoading &&(<Card style={{width: 600}}>
                ...
                <Card style={{width: 500}}>
                    ...
                    <p>Foodie Sky</p>
                    <div>
                        {orderInfo?.orderDetailList.map((item, index) => (
                            <div key={index}>
                                <Row>
                        ...
                        <div className="site-card-border-less-wrapper">
                            <Card bordered={false}>
                                ...
                                <Row>
                                    ...
                                    <Col span={4}>{orderInfo?.amount ? ((orderInfo.amount) / 1.15).toFixed(2) : "N/A"}</Col>
                                </Row>
                                <div style={{marginTop: '16px'}}></div>
                                <Row>
                                    <Col span={20}>Tax & Others</Col>
                                    <Col span={4}>{orderInfo?.amount ? ((orderInfo.amount) * 0.15).toFixed(2) : "N/A"}</Col>
                                </Row>
                                <hr/>
                                <div style={{marginTop: '16px'}}></div>
                                <Row>
